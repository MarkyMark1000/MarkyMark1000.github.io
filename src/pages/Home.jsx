    ...
    <div className="min-h-screen bg-indigo-50 dark:bg-black">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          >
            <p>
              Software engineer with a strong foundation in maths and physics,
              experienced in Python and Flask for backend development and
              passionate about frontend technologies like Vue 3, React, HTML,
              and CSS. Also brings a background in finance with expertise in
          ...
          >
            <p>
              Python, SQL, SQLAlchemy, Flask, Pandas, Numpy, FastAPI, Django,
              Docker, AWS, Vue3, React, JavaScript, HTML, CSS
            </p>
          </Card>
        </div>
