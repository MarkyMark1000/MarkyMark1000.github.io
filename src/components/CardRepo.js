    ...
    >
      ...
      <div 
        ...
        style={{ 
          ...
          maskImage: 'linear-gradient(to right, black 0%, black 45%, transparent 55%)',
          WebkitMaskImage: 'linear-gradient(to right, black 0%, black 45%, transparent 55%)'
        }}
      />
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(to right, transparent 0%, transparent 45%, rgba(71,71,135,0.8) 50%, rgba(71,71,135,1) 55%, rgba(71,71,135,1) 100%)'
        }}
      />
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(to right, transparent 0%, transparent 45%, rgba(31,41,55,0.8) 50%, rgba(31,41,55,1) 55%, rgba(31,41,55,1) 100%)'
        }}
      />
